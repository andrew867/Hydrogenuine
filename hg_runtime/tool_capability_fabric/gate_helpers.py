"""Shared helpers for tool capability fabric gates."""
...
PROOFS = WORKSPACE / "docs" / "proofs" / "tool_capability_fabric"
...
__all__ = ["DEFAULT_REGISTRY", "PROOFS", "WORKSPACE", "base_report", "now_stamp", "run_script", "write_report"]
