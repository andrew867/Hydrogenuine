...
export default function ProductProfile({ onLogout }) {
  ...
  return (
    <Layout title="Profile" onLogout={onLogout}>
      ...
      <section className="section-card" style={{ marginBottom: 16 }}>
        ...
        <p style={{ marginTop: 0, color: 'var(--muted)' }}>
          Dates and times default to your browser locale. Set override for deterministic display.
        </p>
