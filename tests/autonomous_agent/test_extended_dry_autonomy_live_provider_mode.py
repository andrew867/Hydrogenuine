"""Extended dry autonomy live provider mode tests."""
...
def _env(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("HG_COGNITIVE_SOAK_MODE", "live_provider_dry_autonomy")
...
def test_provider_mode_records_health(tmp_path, monkeypatch):
