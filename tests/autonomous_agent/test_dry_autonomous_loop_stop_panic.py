"""Dry autonomous loop STOP/PANIC tests."""
...
from hg_runtime.dry_autonomous_loop.stop_panic import (
    check_panic,
    check_stop,
    create_panic_file,
    create_stop_file,
...
def test_stop_not_model_mediated():
    text = (WORKSPACE / "hg_runtime/dry_autonomous_loop/stop_panic.py").read_text(encoding="utf-8")
