"""Shared proof gate runner for Batch P1-A."""
...
SLICE_TEST_TARGETS: dict[str, list[str]] = {
    "syn": ["tests/syn", "tests/policy_batch_a/test_all_slices.py::test_each_slice_green"],
    "aid": ["tests/aid", "tests/policy_batch_a/test_all_slices.py::test_each_slice_green"],
    "dmi": ["tests/dmi", "tests/policy_batch_a/test_all_slices.py::test_each_slice_green"],
    "all": ["tests/syn", "tests/aid", "tests/dmi", "tests/policy_batch_a"],
}
...
def run_policy_gate(workspace: Path, *, slice: str, gate_id: str, proof_subpath: str) -> int:
    ...
    checks = run_policy_batch_a_checks(workspace, slice=slice)
    ...
    gate_result: dict[str, Any] = {
        ...
        "slice": slice,
        "ok": gate_ok,
        "slices": list(P1_A_SLICES) if slice == "all" else [slice],
        "verdicts": [
            {
