"""Shared RTC design closure checks for ERB batch slices."""
...
def erb_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_erb_rtc_event_design(events)
    return [
        PolicyBatchCheck(
