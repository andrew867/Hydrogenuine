"""Shared RTC design closure checks for EGI batch slices."""
...
def egi_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_egi_rtc_event_design(events)
    return [
        PolicyBatchCheck(
