"""OUX-LIVE import fences — no OEA/TER/GPP mint/UEAK/SRP apply."""
...
_PACKAGE_ROOTS = (
    Path(__file__).resolve().parents[2] / "hg_runtime" / "live_operator_ux",
)


def check_oux_import_fences() -> tuple[bool, list[str]]:
    failures: list[str] = []
...
__all__ = ["advisory_only_marker", "check_oux_import_fences"]
