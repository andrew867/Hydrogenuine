"""ORI cluster import fences — no OEA/TER/GPP mint/UEAK/SRP apply."""
...
_PACKAGE_ROOTS = (
    Path(__file__).resolve().parents[2] / "hg_runtime" / "operator_review_intake",
)


def check_ori_import_fences() -> tuple[bool, list[str]]:
    failures: list[str] = []
...
__all__ = ["advisory_only_marker", "check_ori_import_fences"]
