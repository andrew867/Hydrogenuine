"""
Viz Phase 1: Adapter from graph_mirror to unified viz schema.
"""
...
def adapt_materializer_graph(
    workspace_root: Path, types: Optional[List[str]] = None, limit: int = 500
) -> Dict[str, Any]:
    """Build graph from materialized views; return { nodes, edges } in unified schema."""
    root = Path(workspace_root)
    nodes_by_id, edges_tuples = build_graph(root)
