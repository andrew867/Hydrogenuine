"""Shared RTC design closure checks for IMB batch slices."""
...
def imb_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_imb_rtc_event_design(events)
    return [
        PolicyBatchCheck(
