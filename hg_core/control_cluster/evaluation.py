"""Control cluster evaluation helpers — advisory-only, explicit containment paths."""
...
ADVISORY_MARKER_KEYS = frozenset({"advisory_only", "permission_granted", "authority_created"})
