"""SRP-LIVE import fences — no OEA/TER/GPP mint/UEAK mint/live landing."""
...
_PACKAGE_ROOTS = (
    Path(__file__).resolve().parents[2] / "hg_runtime" / "live_srp_apply",
)


def check_srp_import_fences() -> tuple[bool, list[str]]:
    failures: list[str] = []
...
def advisory_only_marker() -> dict[str, bool]:
    return {
        ...
        "srp_apply_is_advisory_only": True,
...
__all__ = ["advisory_only_marker", "check_srp_import_fences"]
