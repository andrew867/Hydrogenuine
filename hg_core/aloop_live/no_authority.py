"""ALOOP-LIVE import fences — no OEA/TER/GPP mint/UEAK/SRP apply/live loop start."""
...
_PACKAGE_ROOTS = (
    Path(__file__).resolve().parents[2] / "hg_runtime" / "live_autonomous_loop",
)


def check_aloop_import_fences() -> tuple[bool, list[str]]:
    failures: list[str] = []
...
def advisory_only_marker() -> dict[str, bool]:
    return {
        ...
        "loop_lease_is_advisory_only": True,
...
__all__ = ["advisory_only_marker", "check_aloop_import_fences"]
