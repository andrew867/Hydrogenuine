"""Shared proof gate runner for Batch S5-A."""
...
SLICE_TEST_TARGETS: dict[str, list[str]] = {
    "sbs": ["tests/sbs", "tests/signaling_batch_a/test_all_slices.py::test_each_slice_green"],
    "dac": ["tests/dac", "tests/signaling_batch_a/test_all_slices.py::test_each_slice_green"],
    "apc": ["tests/apc", "tests/signaling_batch_a/test_all_slices.py::test_each_slice_green"],
    "all": [
        "tests/sbs",
        "tests/dac",
        "tests/apc",
        "tests/signaling_batch_a",
    ],
}
...
def run_signaling_gate(workspace: Path, *, slice: str, gate_id: str, proof_subpath: str) -> int:
    ...
    checks = run_signaling_batch_a_checks(workspace, slice=slice)
    ...
    gate_result: dict[str, Any] = {
        ...
        "slice": slice,
        "ok": gate_ok,
        "slices": list(S5_A_SLICES) if slice == "all" else [slice],
        "verdicts": [
            {
...
__all__ = ["SLICE_TEST_TARGETS", "run_signaling_gate"]
