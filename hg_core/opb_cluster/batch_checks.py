"""Shared RTC design closure checks for OPB batch slices."""
...
def opb_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_opb_rtc_event_design(events)
    return [
        PolicyBatchCheck(
