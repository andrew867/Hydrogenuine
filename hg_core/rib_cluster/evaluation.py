"""RIB cluster evaluation helpers — advisory-only, explicit containment paths."""
...
def resolve_inheritance_containment(
    *,
    risk: str | None,
...
__all__ = [
    ...
    "resolve_inheritance_containment",
]
