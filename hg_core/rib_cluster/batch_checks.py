"""Shared RTC design closure checks for RIB batch slices."""
...
def rib_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_rib_rtc_event_design(events)
    return [
        PolicyBatchCheck(
