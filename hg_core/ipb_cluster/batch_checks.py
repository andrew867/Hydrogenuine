"""Shared RTC design closure checks for IPB batch slices."""
...
def ipb_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_ipb_rtc_event_design(events)
    return [
        PolicyBatchCheck(
