"""EXCITON cluster batch RTC design checks."""
...
def exciton_rtc_design_checks(
    *,
    prefix: str,
    events: tuple[dict[str, Any], ...],
    minimum_events: int,
) -> list[PolicyBatchCheck]:
    valid, failures = validate_exciton_rtc_event_design(events)
    return [
        PolicyBatchCheck(
...
__all__ = ["exciton_rtc_design_checks"]
